...
class Client:
    ...
    def __init__(
        ...
        if dhcp_version == 4:
            ...
            self._api_extractors: tuple[tuple[str, Callable[[dict, Pool], int]], ...] = (
    ...
    def _create_session(self) -> Session:
        ...
        if self._http_basic_username is not None and self._http_basic_password is not None:

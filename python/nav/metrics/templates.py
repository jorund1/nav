...
def metric_path_for_dhcp_pool(server_name, pool_name, range_start, range_end, metric_name):
    tmpl = "nav.dhcp.pool.{server_name}.{pool_name}.{range_start}.{range_end}.{metric_name}"

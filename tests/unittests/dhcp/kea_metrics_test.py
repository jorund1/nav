...
def valid_dhcp6():
    ...
    expected_metrics = [
        ...
        DhcpMetric(
            datetime.fromisoformat("2024-07-05T20:44:54.230608+00:00").timestamp(),
            IP("2001:db8:1:1::/64"),
            DhcpMetricKey.ASSIGNED,
            0,
        ),
        DhcpMetric(
            datetime.fromisoformat("2024-07-05T09:15:05.626594+00:00").timestamp(),
            IP("2001:db8:1:1::/64"),
            DhcpMetricKey.ASSIGNED,
            1,
        ),
        ...
        DhcpMetric(
            datetime.fromisoformat("2024-07-05T20:44:54.230609+00:00").timestamp(),
            IP("2001:db8:1:2::/64"),
            DhcpMetricKey.ASSIGNED,
            1,
        ),
        DhcpMetric(
            datetime.fromisoformat("2024-07-05T09:15:05.626595+00:00").timestamp(),
            IP("2001:db8:1:2::/64"),
            DhcpMetricKey.ASSIGNED,
            2,
        ),
